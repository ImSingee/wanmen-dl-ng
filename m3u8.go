...
func downloadLectureM3U8(info *LectureInfo, target string, full bool, f updateProgressFunc) (int, error) {
...
type updateProgressFunc func(state string, params ...interface{})
