...
func tryDownloadLectureM3U8(url string, target string, noConvert bool, full bool, reportProgress updateProgressFunc) error {
...
func convertToMp4(target, partDonePath string, reportProgress updateProgressFunc) error {
